(() => {
  ...
  // ns-hugo-imp:/home/mihai/work/projects/parohiaparculcalarasi/parohiaparculcalarasi.ro/themes/hugo-theme-bootstrap/assets/search/search.ts
  ...
  // ns-hugo-imp:/home/mihai/work/projects/parohiaparculcalarasi/parohiaparculcalarasi.ro/themes/hugo-theme-bootstrap/assets/search/engine.ts
  var Engine = class {
    fuse;
    pages = [];
  ...
  // ns-hugo-imp:/home/mihai/work/projects/parohiaparculcalarasi/parohiaparculcalarasi.ro/themes/hugo-theme-bootstrap/assets/search/form.ts
  var Form = class {
    constructor(form, callback) {
      this.form = form;
      ...
      for (; i < this.results.length && count < this.paginate; i += 1, count += 1) {
        ...
        if (content.length > this.resultContentCharactersCount) {
          ...
          if (contentKeywords.length > 0) {
            ...
            if (pos + contentKeywords[0].length > this.resultContentCharactersCount - 1) {
              contentStart = pos;
            }
          }
